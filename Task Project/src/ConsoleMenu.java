...
public class ConsoleMenu {
    ...
    public static void mainSystem()
    {
        ...
        while(true)
        {
            ...
            else if(ans.equals("0"))
            {
                ...
                theProject = new Project(projectName,new Task(new ArrayList<Task>(),null,baseNodeName,description),projectName);
                projectEditor(theProject,reader);
                break;
    ...
    public static void projectEditor(Project theProject, Scanner reader)
    {
        while(true)
        {
            ...
            System.out.println("Press 1 for rename project");
    ...
    public static void changeTask(Task task, Scanner reader, Project theProject)
    {
        while(true)
        {
            ...
            else if(ans.equals("5"))
            {
                ...
                Task newSub = new Task(new ArrayList<Task>(),task,name,description,time);
